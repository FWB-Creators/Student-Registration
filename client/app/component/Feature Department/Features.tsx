    ...
    <div className="py-6 pb-16 bg-gray-50">
        <div className="w-10/12 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 items-center gap-[1.4rem]">
            {disciplines.map((discipline, index) => (
                ...
                <div className="border-gray-500 bg-white p-6 rounded-3xl hover:shadow-lg transition-all duration-300 cursor-pointer hover:scale-105 flex items-center w-full">
                <div>
                    <div className="ml-6">
