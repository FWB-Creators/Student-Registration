...
export default function Form() {
    return (
        <div className='bg-white px-20 py-20 rounded-3xl border-2 border-gray-100'>
            ...
            <div className='mt-8'>
                ...
                <div className='mt-8 flex flex-col gap-y-4'>
                    <button className='active:scale-[.98] active:duration-75 transition-all hover:scale-[1.01] ease-in-out py-3 rounded-xl bg-orange-500 text-white text-lg font-bold'>Sign in</button>
                    <div className='flex justify-center gap-8'>
                        <button className='flex rounded-full py-3 border-2 border-gray-100 item-center justify-center gap-2 px-8 transition duration-300 ease-in-out hover:bg-gray-100'>
                            <svg className='mt-0.5 ml-0.5' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="27" height="27" viewBox="0 0 48 48">
                        ...
                        <button className='flex rounded-full py-3 border-2 border-gray-100 item-center justify-center gap-2 px-8 transition duration-300 ease-in-out hover:bg-gray-100'>
                            <svg className='ml-0.5' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="30" height="30">
                                <path fill="#1877F2" d="M12 2C6.48 2 2 6.48 2 12c0 4.95 3.625 9.025 8.375 9.775v-6.934H7.625V12h2.75V9.844c0-2.723 1.621-4.225 4.111-4.225 1.188 0 2.276.088 2.575.125v2.75h-1.75c-1.388 0-1.625.656-1.625 1.594V12h3.375l-.625 3.842h-2.75v6.934C18.375 21.025 22 16.95 22 12c0-5.52-4.48-10-10-10z"/>
                            </svg>
                            {/* Sign in with Facebook */}
                        </button>
                        <button className='flex rounded-full py-3 border-2 border-gray-100 item-center justify-center gap-2 px-8 transition duration-300 ease-in-out hover:bg-gray-100'>
                            <svg className='mt-0.5 ml-0.5' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="25" height="25">
                ...
                <div className='mt-8 flex justify-center items-center'>
                    ...
                    <button className='text-orange-500 text-base font-medium ml-2'>Sign up</button>
                </div>
            </div>
        </div>
    )
