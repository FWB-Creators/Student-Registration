        ...
        <div className='h-[8vh] bg-white shadow-md'>
            <div className='w-[85%] flex items-center justify-between mx-auto h-[8vh]'>
                ...
                <div className='flex items-center space-x-2 md:space-x-5 relative'>
                    <button
                        className='hover:text-orange-500 font-semibold hidden lg:flex ml-auto'
                        onClick={handleDropdownToggle}
                    >
                        <span className='text-lg'>Sikares</span>
                        <ChevronDownIcon  
                            className={`ml-1 hover:text-orange-500 w-[1rem] h-[2rem] text-slate-900 cursor-pointer ${
                    ...
                    {showDropdown && (
                        <div className="absolute top-full right-0 mt-1 bg-white rounded-md shadow-lg">
                            <ul className="py-1 w-28">
                                <li className="text-md font-semibold cursor-pointer hover:bg-gray-50 hover:text-orange-500 transition-all duration-200 px-4 py-4">Edit Profile</li>
                                <li className="text-md font-semibold cursor-pointer hover:bg-gray-50 hover:text-orange-500 transition-all duration-200 px-4 py-4">Log Out</li>
                            </ul>
                        </div>
                    )}
                </div>
