...
const Profile = () => {
    return (
        <div className='bg-gray-50'>
            ...
            <div className='bg-[#FFA842] w-10/12 px-16 py-10 rounded-3xl flex items-center justify-between'>
                <div>
                    <p className='text-white pb-10'>May 15, 2024</p>
                    <h1 className='text-white text-4xl font-semibold'>Welcome back, HILLY!</h1>
                    <p className='text-white pt-4'>Always stay updated in your student portal</p>
                </div>
                <div className="active:scale-[.98] active:duration-75 transition-all hover:scale-[1.05] ease-in-out mr-20">
                    <Image src="/static/Fox1.png" alt="Fox" width={220} height={220} />
                </div>
            </div>
            </div>
            <div className='flex justify-center my-5'>
